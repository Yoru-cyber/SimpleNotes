...
export default function NoteDetailScreen() {
    ...
    const getNote = async () => {
        ...
        const handleSave = () => {
            NoteService.update(idInt, title, body);
            setIsEditing(false);
        };
        ...
        return (
            <ThemedView style={styles.container}>
                <Stack.Screen options={{
                    ...
                    headerRight: () => (
                        /* Use standard View here, NOT ThemedView, to avoid background "patches" */
    ...
    const styles = StyleSheet.create({
        ...
        headerRightContainer: {
            flexDirection: 'row',
            alignItems: 'center',
            gap: 15, // Space between trash and pencil
        },
        headerIcon: {
            padding: 4,
        },
